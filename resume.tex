...
\begin{itemize}
    \item[\linkedlist{a}] {
        ...
        \begin{itemize} \itemsep 4pt
            \item Expanding multiple back-end projects
            \item Optimizing PHP scripts by inspecting Database/ORM calls
            \item Library \& Package Development
...
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
	\item Serving as a TA for PGM1: Programmeren I, an undergraduate course introducing the concept of \textbf{functional programming} with Python.
\end{itemize}
