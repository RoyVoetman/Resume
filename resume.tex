...
\begin{itemize} \itemsep 1pt
	...
	\item Application stack: \textbf{C\scalebox{0.7}{++}}
\end{itemize}
...
\begin{itemize}
    \item[\linkedlist{a}] {
        ...
        \begin{itemize} \itemsep 4pt
            ...
            \item Successfully migrated proprietary software to open source libraries \& packages
    ...
    \item[\linkedlist{b}] {
        ...
        \vspace{-1mm}
        \begin{itemize} \itemsep 1pt
            \item Assignment: engineered a \textbf{Laravel} application that extracts \textbf{ePub files} (ebooks) and automatically \textbf{classifies} the content into different categories (e.g. Headings, Paragraphs, Images).
        \end{itemize}
    }
\end{itemize}
...
\vspace{1mm}
\emph{Current GPA: 4.0 of 4.0 (US scale), Average grade: 8.7 (European scale)}\\
\vspace{2mm}
