...
\textbf{RDW - Dienst Wegverkeer} \hfill\\
\begin{itemize}
    \item[\linkedlist{a}] {
        \textit{Cloud Solutions Architect $\cdot$ Full-time} \hfill \textcolor{black}{Jan 2024 | Present}\\
        \vspace{-1mm}
        \begin{itemize} \itemsep 4pt
            \item \textcolor{gray}{A committed member of the Cloud Architecture Board, concentrating \\ on "Cloud Integration" across our On-Premises, SaaS, and PaaS solutions.}
        \end{itemize}
    }
    \item[\linkedlist{b}] {
        \textit{Cloud Solutions Engineer $\cdot$ Full-time} \hfill \textcolor{black}{Jul 2023 | Dec 2023}\\
        \vspace{-1mm}
        \begin{itemize} \itemsep 1pt
            \item \textcolor{gray}{Developer for the Cloud Integration Platform (CIP) team.}
            \item \textcolor{gray}{Skills: \texttt{OAuth, C\#, Visio, Azure Functions}}
        \end{itemize}
    }
\end{itemize}
