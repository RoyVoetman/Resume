...
\begin{itemize} \itemsep 1pt
    \item[--] Researching the practical applications of quantum computing for businesses.
    \item[--] Creating a PoC for the use case of quantum machine learning where data can be clustered via traditional and quantum algorithms.
    \item[--] Application stack: \textbf{Qiskit, Scikit-Learn, Azure Functions, Python}
\end{itemize}
...
\begin{itemize} \itemsep 1pt
    ...
    \item[--] Devised a redesign for a legacy codebase focused on maintainability and portability.
	\item[--] Grade: 10/10, Application stack: \textbf{C\scalebox{0.7}{++}, NVIDIA Drive, Carla Simulator, PID Controllers}
\end{itemize}
...
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
	\item[--] Developed single page applications ensuring that clients’ visions and requirements were met.
