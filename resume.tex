...
\textbf{Software Architect} \hfill Groningen, Netherlands\\
\textit{RDW $\cdot$ Internship} \hfill Feb 2021 | Present\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item Assignment: \textbf{autonomous vehicle} development via the \textbf{Nvidia Drive} platform in combination with the \textbf{CARLA} driving simulator, as a result, expanding RDW’s expertise in autonomous vehicles.
	\item Application stack: \textbf{UML, SOLID Principles, Design Patterns, C\scalebox{0.7}{++}, CMake}
\end{itemize}
...
\begin{itemize}
    \item[\linkedlist{a}] {
        ...
        \begin{itemize} \itemsep 4pt
            ...
            \item Effectively optimized the runtime of legacy PHP scripts by inspecting Database/ORM calls.
