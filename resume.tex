...
\textbf{Software Engineer} \hfill \textcolor{black}{Feb 2022 | Present}\\
\textit{CGI $\cdot$ Graduation Internship}\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item[--] \textcolor{gray}{Researching the practical applications of \textcolor{darkgray}{quantum computing} for businesses.}
    ...
    \item[--] \textcolor{gray}{Application stack: \texttt{Qiskit, Scikit-Learn, Azure Functions, Python}}
\end{itemize}
...
\begin{itemize} \itemsep 1pt
	...
	\item[--] \textcolor{gray}{Application stack: \texttt{C\scalebox{0.7}{++}, NVIDIA Drive, Carla Simulator, PID Controllers}}
\end{itemize}
...
\begin{itemize}
    \item[\linkedlist{a}] {
        ...
        \begin{itemize} \itemsep 4pt
        	...
        	\item \textcolor{gray}{Application stack: \texttt{Laravel, PHP, PHPUnit, MariaDB, JS, jQuery, Redis}}
        \end{itemize}
    }
    \item[\linkedlist{b}] {
...
\begin{itemize} \itemsep 1pt
	...
	\item[--] \textcolor{gray}{Application stack: \texttt{JS, Vue, JWT, REST APIs}}
\end{itemize}
...
\begin{itemize} \itemsep 1pt
	...
	\item[--] \textcolor{gray}{Application stack: \texttt{PHP, MSSQL, JS, JQuery}}
\end{itemize}
...
\vspace{1mm}
\textcolor{gray}{
	\emph{Nominated for the Thesis Award with my thesis on: “\textcolor{darkgray}{the practical applications of quantum computing for businesses}”}
}\\
...
\vspace{-2mm}
\begin{itemize} \itemsep 1pt
	\item[--] Hosted an intensive two week study program on working with PHP and Laravel.
\end{itemize}
\textbf{Teaching Assistant} \hfill \textcolor{gray}{Sep 2019 | Feb 2022}\\
\textit{Hanze University of Applied Sciences Groningen}\\
\vspace{-2mm}
\begin{itemize} \itemsep 1pt
	\item[--] Hosted labs and graded problem sets for Hanze’s part-time IT bachelors programme.
	\item[--] Hosted recitation hours for PGM1 \& PGM2, Hanze’s introduction to computer science courses.
