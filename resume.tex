...
\textit{Backend Developer} \hfill Mar 2018 - Present\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
	\item At this company, I am responsible for the development and expansion of multiple \textbf{(Laravel)} back-end projects. For example, in this position, I designed an algorithm that extracts ePub files (ebooks) and then automatically classifies the content into different categories (e.g. Headings, Paragraphs, Images, Footnotes, etc.)
\end{itemize}
\textbf{Hanze University of Applied Sciences Groningen} \hfill Groningen, Netherlands\\
\begin{itemize}
    \item[\linkedlist{a}] {
        \textit{Member of Information Team} \hfill Oct 2019 - Jul 2020\\
        \vspace{-1mm}
        \begin{itemize} \itemsep 1pt
            \item[] At this position, I shared my experiences about the pursuit of a Bachelors degree in the field of IT at events from the Hanze University of Applied Sciences (e.g. Workshop days, Parent-teacher conferences, Open days, etc.)
        \end{itemize}
    } 
    \item[\linkedlist{b}] {
