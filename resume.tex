...
\begin{itemize} \itemsep 1pt
    ...
    \item[--] \textcolor{gray}{Creating a PoC for the use case of quantum machine learning where data can be clustered via traditional and quantum algorithms.}
...
\begin{itemize} \itemsep 1pt
	...
	\item[--] \textcolor{gray}{Grade: 10/10, Application stack: \texttt{C\scalebox{0.7}{++}, NVIDIA Drive, Carla Simulator, PID Controllers}}
\end{itemize}

\textbf{NoardCode} \hfill\\
\begin{itemize}
    \item[\linkedlist{a}] {
        \textit{Back-end Developer $\cdot$ Part-time} \hfill \textcolor{gray}{Jun 2018 | Feb 2021}\\
        \vspace{-1mm}
        \begin{itemize} \itemsep 4pt
            \item \textcolor{gray}{Initiated the migration of proprietary packages to \textcolor{darkgray}{open source packages}.}
            \item \textcolor{gray}{Optimised the runtime of PHP scripts by inspecting Database/ORM calls.}
...
\begin{itemize} \itemsep 1pt
	...
	\item[--] \textcolor{gray}{Application stack: \texttt{JS, Vue.js, JWT, REST APIs}}
\end{itemize}
...
A PHP package that has \textbf{over 7.900} downloads on GitHub.
\vspace*{2mm}
